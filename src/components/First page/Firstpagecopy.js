...
// 			{data.map(tile => (
// 			  <GridListTile key={tile.imgUrl}  cols={tile.cols || 1} style={{borderRadius: '10px'}} >
// 				<img src={tile.imgUrl} alt={tile.title}  style={{border: '1px, solid, transparent',borderRadius: '10px'}}/>
// 			  </GridListTile>
// 			))}
// 		  </GridList>
// 		</div>
